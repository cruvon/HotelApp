...
public class ParameterizationLoopTest extends HotelAppBusinessFunctions
{
	...
	public void test() throws Exception
	{
		...
		int rowcount= HA_GF_XLRowCount (strFilePath,"Location");
		...
		clickLogin(driver);
		//wait(8);
		strlocation= HA_GF_readXL(i,"Location",strFilePath);
		//wait(8);
